...
const Header: React.FC<HeaderProps> = ({ cartItemCount, onCartClick, onNavigate, currentView, user, onLogout }) => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            ...
            {currentView === 'shop' ? (
              <div className="sm:hidden flow-root">
                <button onClick={onCartClick} className="group -m-2 p-2 flex items-center relative">
                  <ClipboardDocumentListIcon className="flex-shrink-0 h-6 w-6 text-gray-400 group-hover:text-gray-500" aria-hidden="true" />
                  {cartItemCount > 0 && (
          ...
          <div className="flex-1 flex justify-end items-center">
            ...
            {/* Logout Button */}
            <button onClick={onLogout} title="Đăng xuất" className="ml-4 p-2 text-gray-500 hover:text-gray-700">
