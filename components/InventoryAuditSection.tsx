...
const InventoryAuditSection: React.FC = () => {
  ...
  : 'Mặc định'}</td>
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-4 no-print bg-gray-50 p-4 rounded-lg border border-gray-100">
          <div className="flex-1">
            ...
            <input 
              ...
              className="w-full border border-gray-200 rounded-md px-3 py-2 text-sm focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 bg-white"
            />
          </div>
          <div className="w-full sm:w-48">
            <label className="block text-sm font-semibold text-gray-700 mb-1">Trạng thái kiểm kê</label>
            <select 
